            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <i>&nbsp;«Аромат – это душа кофе, если и её научатся подделывать, то жить будет совсем тоскливо».</i>
                        </div>
                    </div>
                    <hr/>
                    <p>На этом сайте ты можешь насладится изысканными вкусами кофе в сочетании с великолепными добавками.</p>
